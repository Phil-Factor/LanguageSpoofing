...
DECLARE @jsonData nvarchar(MAX)=N'{
   ...
   "doesSomethingWith":[
	  ...
	  "reflects on","examines","observes","offers","scrutinises"
   ],
   "interaction":[
...
"somethings":[
	  ...
	  "carea","Ambivalences","Neoliberalisms","^adjective Identities","Transcendences","Resistances",
   ...
   "and":["and its relationship to","in combination with", "in contrast to", "and its intersections with",
       "in its paradoxical relationship to","in conjunction with"],
   "stuff":["particular texts","diary entries","painstaking research","diary musings","sporadic poetry",
   ...
   "meditating":["^doingSomethingTo the ^something and ^something",
   ...
   "doingSomethingTo":["understanding","intervening in", "engaging with", "interpreting",
